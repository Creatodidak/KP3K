...
class AddLahan : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_add_lahan)
            ...
            fusedLocationClient.lastLocation
                .addOnSuccessListener { location: Location? ->
                    if (location != null) {
                        ...
                        showError(this@AddLahan, "Lokasi Tidak Ditemukan", "Pastikan GPS aktif & izin diberikan.")
                    }
                }
                .addOnFailureListener { e ->
                    Log.e("MAPS", "Failed to get location: ${e.message}")
                    showError(this@AddLahan, "Gagal Lokasi", "Tidak bisa mendapatkan lokasi.")
                }
        }
    ...
    private suspend fun saveToLocal(){
        ...
        try {
            ...
            val lahanke = (countLahanOwner.size + countLahanOwnerOnDraft.size + 1).toString()
    ...
    private suspend fun saveToServer(data: LahanDraftEntity){
        try{
            val res = Client.retrofit.create(LahanEndpoint::class.java).addLahan(
                LahanAddRequest(
                    data.type.name,
                    data.komoditas,
                    data.owner_id,
            ...
            if(res.isSuccessful && res.body() != null && res.body()?.data != null){
                ...
                newData.let { it ->
                    ...
                    if (resInsert > 0) {
                        ...
                        showSuccess("Berhasil",res.body()?.msg.toString())
                    }else{
